...
namespace UnityConstants
{
  public static class Axes
  {
    ...
    public const string DPADHOR = "DPADHOR";
    public const string DPADVER = "DPADVER";
    public const string STICKLHOR = "STICKLHOR";
    public const string STICKLVER = "STICKLVER";
    public const string STICKRHOR = "STICKRHOR";
    public const string STICKRVER = "STICKRVER";
